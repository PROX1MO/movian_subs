...
class subs
{
	...
	protected function getTitle($title)
	{
		...
		$remove_suffixes = array('SD', 'HD', 'FHD', 'UHD', 'TrueHD', 'NF', 'AMZN', 'DC', 'XviD', 'Pk', 'TS', '2K', '4K', '480p', '576p', '720p', '1080p', '1440p', '2160p', 'Web', 'BluRay', 'BRRip', 'iNTERNAL', 'PROPER', 'x264', 'x265', 'AC3', 'DTS', 'Atmos', 'HUD', '\[', '');
